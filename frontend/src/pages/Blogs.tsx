    ...
    return (
        <div>
            ...
            <div className="flex flex-col mt-2 items-center space-y-3">
              ...
              <BlogCard
                key={blog.id}
                authorName={blog.author.name || "NoName"}
                title={blog.title}
            ...
            <div className="flex justify-center mt-4 mb-4">
              <button
                ...
                className="mr-5 font-normal bg-emerald-500 h-7 w-30 text-white px-2 rounded hover:bg-emerald-600 disabled:bg-blue-300">
                Load More
              </button>
            </div>
            )}
